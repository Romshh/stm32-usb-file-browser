  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if (raw_z > 50){
		  ...
		  sprintf(text,"X:%4u Y:%4u Z:%4u",raw_x,raw_y,raw_z);
		  lcd_text(10, 10, text, WHITE, BLACK, 2);
		  screen_x = touch_map(raw_y, TOUCH_Y_MIN, TOUCH_Y_MAX, LCD_W);
		  screen_y = touch_map(raw_x, TOUCH_X_MIN, TOUCH_X_MAX, LCD_H);
